...
---
Today, we are looking at how tendon-driven continuum robots (TDCR) are modelled using the [constant curvature kinematics framework]({% post_url /2022-12-02-cc-kinematics %}) introduced last month. In doing so, we assume that the TDCR undergoes a pure bending motion, i.e. has infinite
